...
def main():
    ...
    if marker1 not in content:
        print(f"WARNING: Could not find '{marker1}' in {path}, skipping insertion")
        return 0
    ...
    if marker2 not in content:
        print(f"WARNING: Could not find '{marker2}' in {path}, skipping override")
        return 1
    ...
    print(f"✓ Successfully patched {path} with Android acquire fence support")
    return 0
